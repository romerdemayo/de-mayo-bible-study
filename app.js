...
const DM_DATA_GUARD=(()=>{
 const DB_NAME='DeMayoBibleDataProtection',STORE_NAME='snapshots',LATEST='latest',INTERNAL='dm_system_',VERSION='110';
 ...
 const schedule=(reason='automatic-save')=>{clearTimeout(timer);timer=setTimeout(()=>put(reason),450)};
 ...
 window.addEventListener('pagehide',()=>{if(userKeys().length)put('page-close')});
